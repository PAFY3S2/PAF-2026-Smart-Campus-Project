          ...
          <div className="max-w-md w-full mx-auto relative z-10">
            ...
            <form onSubmit={formik.handleSubmit} className="space-y-6">
              <div className="space-y-1.5 group">
                <label className={`text-[10px] font-black uppercase tracking-widest ml-4 transition-colors ${formik.touched.email && formik.errors.email ? 'text-rose-500' : 'text-slate-500 group-focus-within/input:text-primary'}`}>
                  CREDENTIAL IDENTITY
                </label>
              ...
              <div className="space-y-1.5 group">
                <label className={`text-[10px] font-black uppercase tracking-widest ml-4 transition-colors ${formik.touched.password && formik.errors.password ? 'text-rose-500' : 'text-slate-500 group-focus-within/input:text-primary'}`}>
                  ACCESS KEY
                </label>
                <div className="relative">
