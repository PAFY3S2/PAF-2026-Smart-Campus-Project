      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-4 border-l border-slate-800/50 pl-6">
          ...
          <div className="relative group">
            <img 
              src={user?.avatar || "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=200&auto=format&fit=crop"} 
              alt={user?.name} 
              className="w-9 h-9 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xl cursor-pointer group-hover:border-primary transition-all" 
            />
