      ...
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="flex items-center justify-between px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-xl font-bold text-[#142B5D] hidden md:block">
              SLIIT Facility Flow <span className="text-[#F5AB24]">Ops</span>
            </div>
          </div>
      ...
      <footer className="bg-[#142B5D] text-white py-20 px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-16">
          <div className="lg:w-1/3">
            ...
            <p className="text-slate-300 font-medium leading-relaxed">
              SLIIT Facility Flow Ops is the official operations management platform for the university, dedicated to providing a world-class infrastructure for academic excellence.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto border-t border-white/10 mt-16 pt-8 text-center">
          <p className="text-slate-400 text-xs font-black tracking-widest uppercase">
            © 2024 SLIIT FACILTY FLOW OPERATIONS HUB. ALL RIGHTS RESERVED.
          </p>
        </div>
      </footer>
    </div>
